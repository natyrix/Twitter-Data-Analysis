...
class Clean_Tweets:
    ...
    def convert_to_numbers(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            logger.info("CONVERTED TO NUMBERS")
        except Exception as e:
            logger.error(e)
        return df
    ...
    def remove_non_english_tweets(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            df = df.query("lang == 'en' ")
            logger.info("NON ENGLISH TWEETS REMOVED")
        except Exception as e:
            logger.error(e)
        return df
    ...
    def remove_place_characters(self, df: pd.DataFrame):
        ...
        try:
            ...
            logger.info("NON-ALPHANUMERIC CHARACTERS REMOVED FROM PLACE")
